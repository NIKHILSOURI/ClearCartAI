...
echo "  python run_interactive.py --image-dir ./my_360_captures/ --output ./results/"
echo ""
echo "  # Batch mode:"
echo "  python run_batch.py --image-dir ./my_360_captures/ --reference img_001.jpg --point 250 300"
echo ""
